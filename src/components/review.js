...
const Reviews = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center py-14 lg:py-28">
      {/* Left Section */}
      <div className="flex lg:pr-36 pb-12 lg:pb-60 flex-col items-center lg:items-start">
      ...
      <div className="w-full lg:w-auto">
        ...
        <div className="flex justify-center lg:justify-end items-center lg:pr-20 gap-4 mb-6">
          <img
            alt="Previous Review"
            className="w-12 lg:w-14 cursor-pointer rotate-180"
            src={arrow}
            onClick={() => {
              if (review.one) {
        ...
        {/* Reviews */}
        <div className="flex overflow-hidden justify-center h-auto lg:h-[375px] w-full lg:w-[580px]">
