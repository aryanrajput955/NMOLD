...
<div> 
  ...
  <h2  data-aos="fade-right" data-aos-delay="50"   data-aos-easing="ease-in-out" className='font-josefin mt-20 ml-28 text-4xl font-semibold text-blue-500  '>Welcome To Electrical Consulting </h2>
  ...
  <p className="absolute top-1/2 left-96  transform -translate-x-1/2 -translate-y-1/2 w-[500px] font-jost font-medium text-2xl ">
  ...
  <img  data-aos="fade-left" data-aos-delay="50"   data-aos-easing="ease-in-out" className='absolute h-[400px] w-[400px] rounded-3xl left-[700px] top-[600px] ' src="./solar_energy.png" alt="" />
<h2    data-aos-once="false" data-aos="fade-left"    data-aos-easing="ease-in-out" className='font-josefin mt-20 ml-28 text-4xl font-semibold text-blue-500  '>WHY CONSULTANCY </h2>
<div   data-aos-once="false" data-aos="fade-left"    data-aos-easing="ease" className=' bg-[#F5F5F5]  shadow-neutral-300 drop-shadow-lg  shadow-lg  ml-20 my-5 border-gray-500 border-2  box-border gap-7 flex flex-col rounded-2xl   h-[630px] w-[1200px]'>
    ...
    <img   data-aos-once="false" data-aos="fade-right"    data-aos-easing="ease-in-out" className=' absolute h-[450px] rounded-3xl left-[1100px] top-[1360px]' src="./engineering.png" alt="" />
<div className='flex mt-10 bg-[#0088ff77] h-[300px]'>
<div   data-aos-once="false" data-aos="fade-left"    data-aos-easing="ease-in-out" className=' ml-36  pt-10 flex flex-col gap-3' >
...
<div>
<div   data-aos-once="false" data-aos="fade-right"    data-aos-easing="ease-in-out" className=' flex flex-col ml-32 pt-16'>
