  ...
  return (
    <>
      <div>
        ...
        <div className=" bg-[#1F1F1F] flex gap-60  h-screen w-screen">
    ...
    />
          ...
          <p className="  text-white text-lg   pt-5 w-[450px] font-medium font-jost">Industrial automation refers to the use of control systems, such as computers, robots, and information technologies, to handle different industrial processes and machinery with minimal human intervention. It is a critical aspect of modern manufacturing and production systems, enabling organizations to improve efficiency, reduce costs, and enhance product quality.</p>
          <div>
          <button
            type="submit"
       ...
       {/* **************************************** */}
       <div className="  flex gap-32  h-screen w-screen">

          <div className=" ml-40 pt-16  flex flex-col justify-start ">
